...
\author{D.  Auddya$^1$, S. Rudraraju$^1$, K. Garikipati$^2$
	\\ \vspace{0.2in}
...
\frame{
	...
	\begin{itemize}
		...
		\end{itemize}
		\item Ongoing numerical work on incorporating (1) A material model in place of the shape model, (2) Active parameter tracking to allow for scaling independent of the number of cells. (3) Modeling scutoids. 
